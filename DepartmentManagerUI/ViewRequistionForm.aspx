<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site1.Master" CodeBehind="ViewRequistionForm.aspx.cs" Inherits="DepartmentEmployeeUI.ViewRequistionForm" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:Button ID="Button12" runat="server" Text="Back" />
    </p>
    </form>
